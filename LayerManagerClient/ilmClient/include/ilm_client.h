 ...
 * \return ILM_TRUE if the method call was successfull
 ...
 * \param[out] width pointer where width of screen should be stored
 * \param[out] height pointer where height of screen should be stored
 * \return ILM_TRUE if the method call was successfull
 ...
 * \param[out] surfaceProperties pointer where the surface properties should be stored
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not get the resolution.
 */
 ...
 * \param[out] layerProperties pointer where the layer properties should be stored
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not get the resolution.
 */
 ...
 * \param[out] NumberOfHardwareLayers pointer where the number of hardware layers should be stored
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not get the resolution.
 */
 ...
 * \ingroup Screen 
 * \param[out] numberOfIDs pointer where the number of Screen Ids should be returned
 * \param[out] IDs pointer where the IDs should be stored
 ...
 * \ingroup Layer 
 * \param[out] length   Pointer where length of ids array should be stored
 * \param[out] array    Array where the ids should be stored,
 ...
 * \ingroup LayerGroup
 * \param[out] length   Pointer where array length of ids should be stored
 * \param[out] array    Array where the id should be stored,
 *                      the array will be allocated inside
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \param[out] length   Pointer where the array length of ids should be stored
 * \param[out] array    Array where the surface id should be stored,
 *                      the array will be allocated inside
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \ingroup Layer 
 * \param[out] layerId  pointer where the id should be/is stored. It is possible
 ...
 * \param[out] layerType    pointer to the layerType where the result should be stored.
 ...
 * \param[out] visibility     pointer where the visibility of the layer should be stored
 ...
 * \param[out] opacity         pointer where the layer opacity should be stored.
 ...
 * \ingroup Layer
 * \param[in] layerId         Id of layer.
 * \param[out] dimension      pointer to an array where the dimension should be stored.
 ...
 * \ingroup Layer
 * \param[in] layerId          Id of layer.
 * \param[in] dimension       pointer to an array where the dimension is stored.
 *                             dimension[0]=width, dimension[1]=height
 *
 *
 * \return ILM_TRUE if the method call was successfull
 ...
 * \ingroup Layer
 * \param[in] layerId         Id of layer.
 * \param[out] position       pointer to an array where the position should be stored.
 *                        dimension[0]=width, dimension[1]=height
 *
 *
 * \return ILM_TRUE if the method call was successfull
 ...
 * \ingroup Layer
 * \param[in] layerId         Id of layer.
 * \param[in] position        pointer to an array where the position is stored.
 ...
 * \ingroup Layer
 * \param[in]  layerId         Id of layer.
 * \param[out] orientation     Address where orientation of the layer should be stored.
 * \note ilmOrientation for more information on orientation values
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \ingroup Layer
 * \param[in] layerId   Id of layer.
 * \param[in] color     array of the color value which is defined in red,green, blue
 ...
 * \ingroup Layer
 * \param[in] layerId       Id of layer.
 * \param[in] surfaceId     array of surface ids
 ...
 * \param[out] capabilities  The address where the capabilites are returned
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 */
 ...
 * \ingroup LayerGroup
 * \param[in] group The id of the created layergroup is returned in this parameter
 *
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \ingroup LayerGroup
 * \param[in] group       The layergroup to be removed
 *
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \ingroup LayerGroup
 * \param[in] group       The layergroup to remove the layer from
 ...
 * surfaces will not be rendered.
 * \ingroup LayerGroup
 * \param[in] group               Id of the layergroup to set the visibility of
 ...
 * \param[in] surfaceId       	The ID of the newly created surface is returned in this parameter
 *
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \param[out] visibility    pointer where the visibility of a surface should be stored
 ...
 * \param[out] opacity    pointer where the surface opacity should be stored.
 ...
 * \ingroup Surface
 * \param[in]  surfaceId       Id of surface.
 * \param[out] orientation     Address where orientation of the surface should be stored.
 * \note ilmOrientation        for information about orientation values
 *
 *
 * \return ILM_TRUE if the method call was successfull
 ...
 * \ingroup Surface
 * \param[in]  surfaceId       Id of surface.
 * \param[out] pixelformat     Pointer where the pixelformat of the surface should be stored
 ...
 * \ingroup SurfaceGroup
 * \param[in] group       The created surfacegroup is returned in this parameter
 *
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \ingroup SurfaceGroup
 * \param[in] group       The surfacegroup to be removed
 *
 *
 * \return ILM_TRUE if the method call was successfull
 * \return ILM_FAILED if the client can not call the method on the service.
 ...
 * \ingroup SurfaceGroup
 * \param[in] group       The surfacegroup to add the surface
 ...
 * \ingroup SurfaceGroup
 * \param[in] group       The surfacegroup to remove the surface from
 ...
 * surfaces will not be rendered.
 * \ingroup SurfaceGroup
 * \param[in] group		  Id of the surfacegroup to set the visibility of
 ...
 * \ingroup SurfaceGroup
 * \param[in] group       Id of the surfacegroup to set the opacity of.
 ...
 * \param[in] layerId	    array of layer ids
