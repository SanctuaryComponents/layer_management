...
public:
	...
	DBUSCommunicatorTest() {
		communicatorUnderTest =new DBUSCommunicator(&mockCommandExecutor,&layerlist);
	};
...
//			lm->layerlist.getCurrentRenderOrder().clear();
	...
	BaseCommunicator* communicatorUnderTest;
...
MATCHER_P(DebugCommandEq, onoff, "DebugCommand has onoff set to %(onoff)s") {
    return ((DebugCommand*)arg)->onoff == onoff;
  }
...
MATCHER_P5(CreateCommandEq, nativeHandle,OriginalWidth,OriginalHeight,createType,pixelformat, "%(*)s") {
    return ((CreateCommand*)arg)->nativeHandle == nativeHandle
    		&& ((CreateCommand*)arg)->OriginalHeight == OriginalHeight
			&& ((CreateCommand*)arg)->OriginalWidth == OriginalWidth
			&& ((CreateCommand*)arg)->createType == createType
			&& ((CreateCommand*)arg)->pixelformat == pixelformat;
...
MATCHER_P2(RemoveCommandEq, idToRemove,typeToRemove, "%(*)s") {
    return ((RemoveCommand*)arg)->idToRemove == idToRemove
    		&& ((RemoveCommand*)arg)->typeToRemove == typeToRemove;
...
MATCHER_P3(SetOpacityCommandEq, id,type,Opacity, "%(*)s") {
    return ((SetOpacityCommand*)arg)->id == id
    		&& ((SetOpacityCommand*)arg)->type == type
    		&& ((SetOpacityCommand*)arg)->Opacity == Opacity;
...
TEST_F(DBUSCommunicatorTest, Commit) {
 ...
 EXPECT_CALL(this->mockCommandExecutor, execute(Field(&Command::commandType,Eq(Command::CommitChanges)) ) ).Times(1);
...
MATCHER_P6(SetSourceRectangleCommandEq, id,typeToSet,x,y,width,height, "%(*)s") {
    return 	   ((SetSourceRectangleCommand*)arg)->id == id
    		&& ((SetSourceRectangleCommand*)arg)->typeToSet == typeToSet
    		&& ((SetSourceRectangleCommand*)arg)->x == x
    		&& ((SetSourceRectangleCommand*)arg)->y == y
    		&& ((SetSourceRectangleCommand*)arg)->width == width
    		&& ((SetSourceRectangleCommand*)arg)->height == height;
...
MATCHER_P6(SetDestinationRectangleCommandEq, id,typeToSet,x,y,width,height, "%(*)s") {
    return 	   ((SetDestinationRectangleCommand*)arg)->id == id
    		&& ((SetDestinationRectangleCommand*)arg)->typeToSet == typeToSet
    		&& ((SetDestinationRectangleCommand*)arg)->x == x
    		&& ((SetDestinationRectangleCommand*)arg)->y == y
    		&& ((SetDestinationRectangleCommand*)arg)->width == width
    		&& ((SetDestinationRectangleCommand*)arg)->height == height;
...
MATCHER_P4(SetPositionCommandEq, id,typeToSet,x,y, "%(*)s") {
    return 	   ((SetPositionCommand*)arg)->id == id
    		&& ((SetPositionCommand*)arg)->typeToSet == typeToSet
    		&& ((SetPositionCommand*)arg)->x == x
    		&& ((SetPositionCommand*)arg)->y == y;
...
MATCHER_P4(SetDimensionCommandEq, id,typeToSet, width,height, "%(*)s") {
    return 	   ((SetDimensionCommand*)arg)->id == id
    		&& ((SetDimensionCommand*)arg)->typeToSet == typeToSet
    		&& ((SetDimensionCommand*)arg)->width == width
    		&& ((SetDimensionCommand*)arg)->height == height;
...
MATCHER_P2(GetOpacityCommandEq, id,type,  "%(*)s") {
    return 	   ((GetOpacityCommand*)arg)->id == id
    		&& ((GetOpacityCommand*)arg)->type == type;
...
MATCHER_P3(SetOrientationCommandEq, id,type,Orientation,  "%(*)s") {
    return 	   ((SetOrientationCommand*)arg)->id == id
    		&& ((SetOrientationCommand*)arg)->type == type
			&& ((SetOrientationCommand*)arg)->Orientation == Orientation;
...
MATCHER_P3(SetVisibilityCommandEq, id,otype,visibility, "%(*)s") {
    return ((SetVisibilityCommand*)arg)->idtoSet == id
    		&& ((SetVisibilityCommand*)arg)->otype == otype
    		&& ((SetVisibilityCommand*)arg)->visibility == visibility;
...
MATCHER_P2(SurfacegroupAddSurfaceCommandEq, surfaceid, surfacegroupid, "%(*)s") {
    return ((SurfacegroupAddSurfaceCommand*)arg)->surfacegroupid == surfacegroupid
    	&& ((SurfacegroupAddSurfaceCommand*)arg)->surfaceid == surfaceid;

  }
TEST_F(DBUSCommunicatorTest, AddSurfaceToSurfaceGroup) {

  SurfacegroupAddSurfaceCommand* p;
...
MATCHER_P2(SurfacegroupRemoveSurfaceCommandEq, surfacegroupid, surfaceid, "%(*)s") {
    return ((SurfacegroupRemoveSurfaceCommand*)arg)->surfacegroupid == surfacegroupid
    	&& ((SurfacegroupRemoveSurfaceCommand*)arg)->surfaceid == surfaceid;
  }
...
MATCHER_P2(LayergroupAddLayerCommandEq, layerid,layergroupid, "%(*)s") {
    return ((LayergroupAddLayerCommand*)arg)->layergroupid == layergroupid
    	&& ((LayergroupAddLayerCommand*)arg)->layerid == layerid;
...
MATCHER_P2(LayergroupRemoveLayerCommandEq, layerid,layergroupid, "%(*)s") {
    return ((LayergroupRemoveLayerCommand*)arg)->layergroupid == layergroupid
    	&& ((LayergroupRemoveLayerCommand*)arg)->layerid == layerid;
...
MATCHER_P2(LayerAddSurfaceCommandEq, surfaceid,layerid, "%(*)s") {
    return ((LayerAddSurfaceCommand*)arg)->layerid == layerid
    	&& ((LayerAddSurfaceCommand*)arg)->surfaceid == surfaceid;
...
MATCHER_P2(LayerRemoveSurfaceCommandEq, surfaceid,layerid, "%(*)s") {
    return ((LayerRemoveSurfaceCommand*)arg)->layerid == layerid
    	&& ((LayerRemoveSurfaceCommand*)arg)->surfaceid == surfaceid;
...
MATCHER_P2(GetDimensionCommandEq, id, type, "%(*)s") {
    return ((GetDimensionCommand*)arg)->id == id
    	&& ((GetDimensionCommand*)arg)->type == type;
  }
...
MATCHER_P2(GetPixelformatCommandEq, id, type, "%(*)s") {
    return ((GetPixelformatCommand*)arg)->id == id
    	&& ((GetPixelformatCommand*)arg)->type == type;
  }
...
MATCHER_P2(GetVisibilityCommandEq, id,type, "%(*)s") {
    return ((GetVisibilityCommand*)arg)->id == id
    		&& ((GetVisibilityCommand*)arg)->type == type;
